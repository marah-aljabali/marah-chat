...
if question:
    ...
    with st.chat_message("assistant"):
        ...
        3. **الدقة:** إذا لم تكن الإجابة في الملفات، يمكنك استخدام قسم الويب التابع لموقع الجامعة فقط، ولكن أخبر الطالب بأن المعلومة من الموقع وليست من ملف.
        4. لا تختلق المعلومات.
        5. خذ النص من الملفات أولا وافهم المقصود بذكاء لأنه ممكن الملفات فيها أخطاء
